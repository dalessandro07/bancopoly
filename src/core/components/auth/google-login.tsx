...
export default function GoogleLogin ({ redirectTo = '/' }: { redirectTo?: string }) {
  ...
  return (
    <Button
      ...
      size="lg"
      className="w-full group relative overflow-hidden bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 shadow-sm hover:shadow-md transition-all duration-200"
    >
      <svg
