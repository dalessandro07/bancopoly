					...
					<div className="bg-card border rounded-lg p-4 space-y-4">
						<div className="space-y-2">
							<p className="text-sm text-muted-foreground">
								Al cerrar la sala, el juego terminará y todos los jugadores
								podrán ver el ranking final y las estadísticas del juego.
							</p>
			...
			<section className="space-y-4">
				...
				<div className="bg-card border border-destructive/20 rounded-lg p-4 space-y-4">
					{isCreator ? (
						<div className="space-y-2">
							<p className="text-sm text-muted-foreground">
								Al eliminar el tablero, todos los jugadores perderán acceso y se
								eliminarán todas las transacciones.
							</p>
						...
						<div className="space-y-2">
							<p className="text-sm text-muted-foreground">
								Al salir del tablero, ya no podrás ver ni participar en el
								juego.
							</p>
