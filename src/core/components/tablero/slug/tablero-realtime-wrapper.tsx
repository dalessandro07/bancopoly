...
const TransactionReceivedCard = dynamic(
	() => import("./transaction-received-card"),
	{
		ssr: false,
	},
);
...
export default function TableroRealtimeWrapper({
	...
	const [transactions, setTransactions] =
		useState<EnrichedTransaction[]>(initialTransactions);
	...
	const [preselectedToPlayerId, setPreselectedToPlayerId] = useState<
		string | undefined
	>(undefined);
