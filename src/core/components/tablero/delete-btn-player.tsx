...
export default function DeleteBtnPlayer({
	playerId,
	tableroId,
}: {
	playerId: string;
		...
		<Dialog open={isOpen} onOpenChange={setIsOpen}>
			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						Esta acción no se puede deshacer. El jugador será eliminado del
						tablero y perderá acceso a todas las transacciones.
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
					<Button
