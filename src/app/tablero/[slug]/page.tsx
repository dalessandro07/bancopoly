...
const FormJoinTablero = dynamic(
	() => import("@/src/core/components/tablero/form-join-tablero"),
	{
		loading: () => (
...
const PlayersList = dynamic(
	() => import("@/src/core/components/tablero/slug/players-list"),
	{
		loading: () => (
...
const TableroRealtimeWrapper = dynamic(
	() => import("@/src/core/components/tablero/slug/tablero-realtime-wrapper"),
	{
		loading: () => (
...
export default async function TableroPage({
	...
	const isPlayer = tablero.players?.some(
		(player) => player.userId === session?.user?.id,
	);
	const currentPlayer = tablero.players?.find(
		(player) => player.userId === session?.user?.id,
	);
