...
export default function TableroSlugLayout({
	...
	const { showConfirm, setShowConfirm, confirmLeave, cancelLeave } =
		useConfirmBack(!isResultados);
			...
			>
				<DialogContent showCloseButton={false}>
					<DialogHeader>
						...
						<DialogDescription>
							Si sales, dejarás de ver el juego en vivo. Puedes volver a entrar
							más tarde con el mismo enlace.
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>
