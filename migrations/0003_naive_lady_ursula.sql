...
CREATE INDEX `player_property_tableroId_idx` ON `player_property` (`tablero_id`);--> statement-breakpoint
CREATE INDEX `player_property_playerId_idx` ON `player_property` (`player_id`);--> statement-breakpoint
CREATE INDEX `player_property_propertyKey_idx` ON `player_property` (`property_key`);--> statement-breakpoint
